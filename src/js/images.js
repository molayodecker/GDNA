...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const pathUrl = 'http://res.cloudinary.com/dwbs6mbsy/image/upload/h_100,l_gdna:backgroundImages:play-button-icon-png-18910_kvhki0,w_100/dpr_auto/v1/gdna/backgroundImages/';

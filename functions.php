...
{
    $version = wp_get_theme()->get('Version');
    wp_enqueue_script('main_script', get_template_directory_uri() . "/src/js/script.js", array(), $version, false);
    wp_enqueue_script('grid_script', get_template_directory_uri() . "/src/js/images.js", array(), $version, false);
}
